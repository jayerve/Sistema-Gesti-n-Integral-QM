 ...
 * @author Juan
 */
public class pre_calendario_horarioXEmpleado_hxe extends Pantalla {
    @EJB
...
private    	String sucu="";
private	String area="",jefe_padre="",cargo_padre="";
...
TablaGenerica tabJefeInmediatos=null;
	...
	public pre_calendario_horarioXEmpleado_hxe() {
		...
		sel_anio_reporte.setTitle("Seleccione Anio Horario");
      ...
      tab_tabla.getColumna("IDE_GTEMP").setNombreVisual("EMPLEADO");
	   ...
	   tab_tabla.getColumna("IDE_GEMES").setNombreVisual("MES");
       ...
       tab_tabla.getColumna("IDE_GEMES").setVisible(false);
 	   tab_tabla.getColumna("IDE_GEMES").setOrden(4);

	   tab_tabla.getColumna("IDE_GEANI").setNombreVisual("ANIO");
	   ...
	   tab_tabla.getColumna("IDE_GEANI").setOrden(5);

       
       
	   tab_tabla.getColumna("dia1").setNombreVisual("DIA1");
	   ...
	   tab_tabla.getColumna("dia1").setOrden(6);
        ...
        tab_tabla.getColumna("dia2").alinearCentro();
 	   	tab_tabla.getColumna("dia2").setOrden(7);
        ...
        tab_tabla.getColumna("dia3").alinearCentro();
 	   	tab_tabla.getColumna("dia3").setOrden(8);
        ...
        tab_tabla.getColumna("dia4").alinearCentro();
 	   	tab_tabla.getColumna("dia4").setOrden(8);
        ...
        tab_tabla.getColumna("dia5").alinearCentro();
 	   	tab_tabla.getColumna("dia5").setOrden(9);
        ...
        tab_tabla.getColumna("dia6").alinearCentro();
 	   	tab_tabla.getColumna("dia6").setOrden(10);
        ...
        tab_tabla.getColumna("dia7").alinearCentro();
 	   	tab_tabla.getColumna("dia7").setOrden(11);
        ...
        tab_tabla.getColumna("dia8").alinearCentro();
 	   	tab_tabla.getColumna("dia8").setOrden(12);
        ...
        tab_tabla.getColumna("dia9").alinearCentro();
 	   	tab_tabla.getColumna("dia9").setOrden(13);
        ...
        tab_tabla.getColumna("dia10").alinearCentro();
 	   	tab_tabla.getColumna("dia10").setOrden(14);
        ...
        tab_tabla.getColumna("dia11").alinearCentro();
 	   	tab_tabla.getColumna("dia11").setOrden(15);
        ...
        tab_tabla.getColumna("dia12").alinearCentro();
 	   	tab_tabla.getColumna("dia12").setOrden(16);
        ...
        tab_tabla.getColumna("dia13").alinearCentro();
 	   	tab_tabla.getColumna("dia13").setOrden(17);
        ...
        tab_tabla.getColumna("dia14").alinearCentro();
 	   	tab_tabla.getColumna("dia14").setOrden(18);
        ...
        tab_tabla.getColumna("dia15").alinearCentro();
 	   	tab_tabla.getColumna("dia15").setOrden(19);
        ...
        tab_tabla.getColumna("dia16").alinearCentro();
 	   	tab_tabla.getColumna("dia16").setOrden(20);
        ...
        tab_tabla.getColumna("dia17").alinearCentro();
 	   	tab_tabla.getColumna("dia17").setOrden(21);
        ...
        tab_tabla.getColumna("dia18").alinearCentro();
 	   	tab_tabla.getColumna("dia18").setOrden(22);
        ...
        tab_tabla.getColumna("dia19").alinearCentro();
 	   	tab_tabla.getColumna("dia19").setOrden(23);
        ...
        tab_tabla.getColumna("dia20").alinearCentro();
 	   	tab_tabla.getColumna("dia20").setOrden(24);
        ...
        tab_tabla.getColumna("dia21").alinearCentro();
 	   	tab_tabla.getColumna("dia21").setOrden(25);
        ...
        tab_tabla.getColumna("dia22").alinearCentro();
 	   	tab_tabla.getColumna("dia22").setOrden(26);
        ...
        tab_tabla.getColumna("dia23").alinearCentro();
 	   	tab_tabla.getColumna("dia23").setOrden(27);
        ...
        tab_tabla.getColumna("dia24").alinearCentro();
 	   	tab_tabla.getColumna("dia24").setOrden(28);
        ...
        tab_tabla.getColumna("dia25").alinearCentro();
 	   	tab_tabla.getColumna("dia25").setOrden(29);
        ...
        tab_tabla.getColumna("dia26").alinearCentro();
 	   	tab_tabla.getColumna("dia26").setOrden(30);
        ...
        tab_tabla.getColumna("dia27").alinearCentro();
 	   	tab_tabla.getColumna("dia27").setOrden(31);
        ...
        tab_tabla.getColumna("dia28").alinearCentro();
 	   	tab_tabla.getColumna("dia28").setOrden(31);
        ...
        tab_tabla.getColumna("dia29").alinearCentro();
 	   	tab_tabla.getColumna("dia29").setOrden(31);
        ...
        tab_tabla.getColumna("dia30").alinearCentro();
 	   	tab_tabla.getColumna("dia30").setOrden(32);
        ...
        tab_tabla.getColumna("dia31").alinearCentro();
 	   	tab_tabla.getColumna("dia31").setOrden(33);
        ...
        tab_tabla.getColumna("activo_ashex").alinearCentro();
 	   	tab_tabla.getColumna("activo_ashex").setOrden(34);
      ...
      //  tab_tabla.getColumna("aplica_hora_extra").setNombreVisual("H.EXT");
       ...
       // tab_tabla.getColumna("aplica_hora_extra").alinearCentro();
        ...
        tab_tabla.getColumna("IDE_SUCURSAL").setLectura(true);
 	   	tab_tabla.getColumna("IDE_SUCURSAL").setOrden(36);
        ...
        tab_tabla.getColumna("IDE_GEARE").setLectura(true);
 	   	tab_tabla.getColumna("IDE_GEARE").setOrden(37);
        ...
        tab_tabla.getColumna("IDE_GEDEP").setLectura(true);
 	   	tab_tabla.getColumna("IDE_GEARE").setOrden(38);
...
*/
    ...
    //    tab_tabla.setCondicion("ide_geani="+anio+" and ide_gemes="+(utilitario.getMes(utilitario.getFechaActual())+1));
       ...
       tab_tabla.setHeader("ASIGNACI�N TURNOS A EMPLEADOS HORAS EXTRA");
...
//Actualizo mi tabla calendario con el mes actual 
  ...
  mes=sel_mes.getValorSeleccionado();
		...
		TablaGenerica tabEmpleadoMensual=utilitario.consultar("select ide_gtemp,ide_ashex "
     ...
     */
		...
		empleado=empleado+",";
/**
 * Valida3cion que limpia la lista para la asignacion de horarios para nuevos empleados
 */
 ...
 */
    ...
    public void guardar() {
        if (tab_tabla.guardar()) {
    		...
    		TablaGenerica tab=utilitario.consultar("select ide_ashex,ide_gtemp from asi_horario_mes_empleado_hex");
...
bandEdit=true;
    ...
    private TablaGenerica obtenerHorarioMesEmpleado(String empleado,String anio,String mes){
    	TablaGenerica horarioXEmpleado=utilitario.consultar("select ide_ashex,ide_gtemp from asi_horario_mes_empleado_hex "
	...
	public void setSel_departamento_empleado(
	 ...
	 public void aceptarAsignarEmpleadoDepartamento(){
		...
		public void aceptarReporte() {
			...
			if (rep_reporte.isVisible()) {
			...
			}else if(rep_reporte.getReporteSelecionado().equals("Asignacion Mensual de Horarios HXE")){
    			...
    			/*	p_parametros.put("titulo", "REPORTE EMPLEADOS POR HORARIO");
			        ...
			        try {
						...
						//String nomEmpleadoJefe=retornaNombreEmpleado(Integer.parseInt(getJefesInmediatos(TabEmpleado.getValor("IDE_GEARE"),0)));
...
*/
						...
						System.out.println("aprobado_por "+ cargo_padre);
