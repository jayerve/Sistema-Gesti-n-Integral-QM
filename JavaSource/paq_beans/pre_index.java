...
public class pre_index {
    ...
    public pre_index() {
        if (utilitario.getConexion() != null && utilitario.getVariable("NICK") != null) {
            ...
            con_guarda.setMessage("¿Esta seguro que desea guardar?");
    ...
    public void aceptarSucursal() {
        if (rad_sucursales.getValue() != null) {
            ...
            utilitario.agregarMensajeInfo("Seleccione Sucursal", "Debe seleccionar una sucursal para iniciar el sistema");
        }
    }
    ...
    public void cargar(ActionEvent evt) {
        ...
        ///aqui se puede configurar los evetos del teclado en el ERP. solo configurado tecla arriba y abajo. Nota esto se enlaza a sistema.js
    ...
    public void ayuda() {
    	...
    	utilitario.ejecutarJavaScript("window.open('" + utilitario.getURL() + "/lista_manuales.html')");
       ...
       /* if (str_manual != null) {
            ...
            System.out.println("window.open('" + utilitario.getURL() + "/manuales/" + str_paquete + "/" + str_manual + "'");
        }*/
    }
