...
//		bar_botones.agregarComponente(che_fecha_conc);
		...
		tab_cliente_consulta.setSql(ser_cliente.getClientesFacturasContratos("-1", "0","1900-01-01","2017-01-01","false","false"));
		...
		tab_cliente_consulta.getColumna("direccion_recli").setNombreVisual("DIRECCIÓN CLIENTE");
		tab_cliente_consulta.getColumna("telefono_factura_recli").setNombreVisual("TELÉFONO DE FACTURA");
		tab_cliente_consulta.getColumna("email_recli").setNombreVisual("E-MAIL");
		...
		tab_cliente_consulta.getColumna("numero_contrato_prcon").setNombreVisual("NRO. CONTRATO");
...
//		tab_cliente_consulta.getColumna("activo_recli").setNombreVisual("ESTADO");
	...
	public void seleccionaOpcion (){
		...
		String fecha_inicial=cal_fecha_inicial.getFecha();
		String fecha_final=cal_fecha_final.getFecha();
		tab_cliente_consulta.setSql(ser_cliente.getClientesFacturasContratos("1","0", fecha_inicial, fecha_final, che_fecha_pago.getValue().toString(),che_fecha_contrato.getValue().toString()));
...
//		tab_cliente_consulta.setSql(ser_cliente.getConsultaClientes("1","0", fecha_inicial, fecha_final, che_fecha_pago.getValue().toString()));
	...
	public boolean isRepFecha_pag() {
		return repFecha_pag;
	}

	public void setRepFecha_pag(boolean repFecha_pag) {
		this.repFecha_pag = repFecha_pag;
	}

	public boolean isRepFecha_conc() {
		return repFecha_conc;
	}

	public void setRepFecha_conc(boolean repFecha_conc) {
		this.repFecha_conc = repFecha_conc;
	}
