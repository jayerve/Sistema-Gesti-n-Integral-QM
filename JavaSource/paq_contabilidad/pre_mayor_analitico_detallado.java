...
public class pre_mayor_analitico_detallado extends Pantalla{
	...
	public pre_mayor_analitico_detallado() {
		...
		tab_tabla1.setSql(ser_contabilidad.getMayorAnalitico_detallado("1900-01-01", "1900-01-01", "-1","-1"));	
	...
	public void imprimirMayorAnalitico(){
		...
		tab_tabla1.setSql(ser_contabilidad.getMayorAnalitico_detallado(cal_fecha_inicial.getFecha(), cal_fecha_final.getFecha(), seleccionados,com_anio.getValue()+""));
