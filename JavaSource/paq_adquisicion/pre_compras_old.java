...
public class pre_compras_old extends Pantalla{
	...
	// Estado de Solicitud de Compra adjudicada
	public static String par_adjudicado; 
	...
	public pre_compras_old(){
		...
		// Estado de Solicitud de Compra adjudicada
		par_adjudicado=utilitario.getVariable("p_adjudicado");
	...
	//	tab_compras.getColumna("ide_prtra").setLectura(true);
		...
		tab_detalle_compras.getColumna("ide_adqdft").setCombo("adq_detalle_factura_tipo", "ide_adqdft", "detalle_adqdf", "");
		tab_detalle_compras.getColumna("ide_adqdft").setAutoCompletar();
	...
	public  void aceptarProveedor(){
		...
		if (str_seleccionado!=null){
			// Estado de Solicitud de Compra adjudicada
			tab_compras.setValor("ide_coest",par_adjudicado); 
	...
	public void aceptarCertificacion(){
		...
		utilitario.addUpdate("tab_compras");
			...
			set_certificacion.cerrar();
			utilitario.agregarNotificacionInfo("Certificación Presupuestaria no es Válida", "La certificación presupuestaria seleccionada no registra partidas presupuestarias para proceder con la solicitud de compra ");
		}
	}
		...
		if(rep_reporte.getReporteSelecionado().equals("Plan Operativo Anual (POA)")){
			if (rep_reporte.isVisible()){
				...
				p_parametros.clear();
					...
					p_parametros.put("ide_geani", pckUtilidades.CConversion.CInt("7"));
					self_reporte.setSeleccionFormatoReporte(p_parametros,rep_reporte.getPath());
				   self_reporte.dibujar();
