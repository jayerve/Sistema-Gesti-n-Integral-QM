...
public class pre_factura_compras extends Pantalla {
	...
	public pre_factura_compras() {
		...
		tab_adq_detalle.getColumna("marca_addef").setRequerida(false);
		tab_adq_detalle.getColumna("serie_addef").setRequerida(false);
		tab_adq_detalle.getColumna("color_addef").setRequerida(false);
		tab_adq_detalle.getColumna("modelo_addef").setRequerida(false);
		tab_adq_detalle.getColumna("descripcion_addef").setRequerida(true);
		...
		tab_adq_detalle.getColumna("ide_adqdft").setCombo("adq_detalle_factura_tipo","ide_adqdft","detalle_adqdf","");
		// tab_adq_detalle.getColumna("ide_adqdft").setAutoCompletar();

		tab_adq_detalle.getColumna("procesado_adfac").setLectura(true);
		tab_adq_detalle.getColumna("procesado_adfac").setValorDefecto("false");
		...
		tab_adq_detalle.getColumna("aplica_iva_adfac").setMetodoChange("calcularSolicitud");
		// Aplica IVA 2016-03-29
	...
	public void aceptaRecepcion() {
		...
		if (lis_recepcion.getValue() == null) {
			utilitario.agregarMensajeInfo("Recepción", "Debe Seleccionar una Opción");
			return;
		} else {
