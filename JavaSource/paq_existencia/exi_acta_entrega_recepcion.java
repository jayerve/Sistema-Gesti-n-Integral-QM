 ...
 * 
 */
public class exi_acta_entrega_recepcion extends Pantalla {
	...
	private String parametroSecuencial = "p_sec_acta_entrega_recepcion_existencia";
	private String tipoDeActa = "12";
	 ...
	 * Constructor
	 */
	public exi_acta_entrega_recepcion() {
	...
	public void aceptarReporte() {
		if (rep_reporte.getReporteSelecionado().equals("Acta Entrega/Recepción")) {
			if (rep_reporte.isVisible()) {
				...
				rep_reporte.cerrar();
				p_parametros.put("titulo", "ACTA ENTREGA RECEPCIÓN DE EXISTENCIAS No. " + tab_cabecera.getValor("nro_secuencial_afdoc"));
