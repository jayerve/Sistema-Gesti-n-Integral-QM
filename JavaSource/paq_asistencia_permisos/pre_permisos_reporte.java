...
public class pre_permisos_reporte extends Pantalla {
	private Calendario cal_fecha_inicial = new Calendario();
	private Calendario cal_fecha_final = new Calendario();

    private Tabla tab_permisos_reporte = new Tabla();

    public pre_permisos_reporte() {
    	...
    	tab_permisos_reporte.getColumna("aprobacion_jefe_inmediato").setNombreVisual("APROBACIÓN JEFE INMEDIATO");
    	...
    	tab_permisos_reporte.getColumna("aprobacion_tthh").setFiltro(true);
       	tab_permisos_reporte.getColumna("aprobacion_tthh").setNombreVisual("APROBACIÓN TTHH");
		...
		pat_panel.setMensajeWarn("RESUMEN DE VACACIÓN POR EMPLEADO");
