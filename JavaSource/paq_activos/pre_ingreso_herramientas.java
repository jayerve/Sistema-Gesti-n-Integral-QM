 ...
 * @since 2017/04/06
 */
public class pre_ingreso_herramientas extends Pantalla {
	...
	private void detalleIngreso() {
		...
		tab_activos_fijos.getColumna("ide_bocam").setCombo(ser_bodega.getCatalagoBodega("true", "'73.14.06'"));
		...
		tab_activos_fijos.getColumna("afi_prestado").setValorDefecto("false");
	...
	private void dialogoActivoLote() {
		...
		tab_act_fij_obj.getColumna("ide_bocam").setCombo(ser_bodega.getCatalagoBodega("true", "'73.14.06'"));
		...
		tab_act_fij_obj.getColumna("VALOR_IVA").setValorDefecto("0");
		/* Combo comprobate */
	...
	public void IngresoLotes() {
		...
		if (tab_act_fij_obj.getValor("VALOR_IVA") == null || tab_act_fij_obj.getValor("VALOR_IVA").isEmpty()) {
			// utilitario.agregarNotificacionInfo("Faltan Campos",
			// "Selecciona el porcentaje de IVA");
			// return;
		}
		if (tab_act_fij_obj.getValor("ide_bocam") == null || tab_act_fij_obj.getValor("ide_bocam").isEmpty()) {
			utilitario.agregarNotificacionInfo("Faltan Campos", "Selecciona una descripcion del Catálogo de Herramientas");
			return;
		}
	...
	public void mostrarDialogoLotes() {
		...
		if (tab_bodega.getValor("ide_boubi") == null) {
			utilitario.agregarMensajeInfo("Debe seleccionar una bodega destino", "");
			return;
		}
		...
		tab_act_fij_obj.setValor("ide_boubi", tab_bodega.getValor("ide_boubi"));

		dia_activo_lote.dibujar();
	}

	public pre_ingreso_herramientas() {
		...
		dia_activo_lote.setTitle("HERRAMIENTAS LOTE");
	...
	public void guardar() {
		...
		if (tab_bodega.getValorSeleccionado().equals("-1")) {
			if (tab_bodega.getValor("ide_tepro") == null) {
				// utilitario.agregarMensajeInfo("Requisito Ingreso",
