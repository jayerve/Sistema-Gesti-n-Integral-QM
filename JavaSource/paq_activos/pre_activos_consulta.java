...
public class pre_activos_consulta extends Pantalla {
	...
	public pre_activos_consulta() {
		...
		tab_consulta_activo.setSql(ser_activo.getConsultaCustodiosYBienes());

		tab_consulta_activo.getColumna("bien_codigo").setFiltroContenido();
		tab_consulta_activo.getColumna("bien_codigo").setLongitud(5);
		...
		tab_consulta_activo.getColumna("bien_ubicacion").setFiltroContenido();
		tab_consulta_activo.getColumna("bien_ubicacion").setLongitud(15);
		...
		tab_consulta_activo.getColumna("factura_numero").setLongitud(10);
		...
		tab_consulta_activo.getColumna("novedad").setFiltroContenido();
		tab_consulta_activo.getColumna("novedad").setLongitud(35);
		...
		tab_consulta_activo.getColumna("cedula").setFiltroContenido();
		tab_consulta_activo.getColumna("cedula").setLongitud(15);
		tab_consulta_activo.getColumna("primer_nombre").setFiltroContenido();
		tab_consulta_activo.getColumna("primer_nombre").setLongitud(25);
		tab_consulta_activo.getColumna("segundo_nombre").setFiltroContenido();
		tab_consulta_activo.getColumna("segundo_nombre").setLongitud(25);
		tab_consulta_activo.getColumna("primer_apellido").setFiltroContenido();
		tab_consulta_activo.getColumna("primer_apellido").setLongitud(25);
		tab_consulta_activo.getColumna("segundo_apellido").setFiltroContenido();
		tab_consulta_activo.getColumna("segundo_apellido").setLongitud(25);
