...
public class pre_activos_consulta_por_custodio_actual extends Pantalla {
	...
	public pre_activos_consulta_por_custodio_actual() {
		bar_botones.limpiar();
		...
		System.out.println("Pantalla pre_activos_consulta_por_custodio_actual ");
		...
		tab_consulta_activo.setSql(ser_activo.getConsultaActivosPorCustodio(ide_gtemp));
	...
	public ServicioEmpleado getServ_empleado() {
		return serv_empleado;
	}

	public void setServ_empleado(ServicioEmpleado serv_empleado) {
		this.serv_empleado = serv_empleado;
	}
