...
public class pre_activos_consulta_unico extends Pantalla {

	private Tabla tab_consulta_activo = new Tabla();
	private Reporte rep_reporte = new Reporte();
	private Map p_parametros = new HashMap();
	private SeleccionFormatoReporte self_reporte = new SeleccionFormatoReporte();
	private SeleccionTabla sel_fil_acta = new SeleccionTabla();
	@EJB
	...
	public void abrirFiltro() {
		sel_fil_acta.getTab_seleccion().setSql(ser_activo.getTipoActas());
		sel_fil_acta.getTab_seleccion().ejecutarSql();
		sel_fil_acta.dibujar();
	}
	...
	public void aceptarFiltro() {
		String str_seleccionado = sel_fil_acta.getSeleccionados();
		tab_consulta_activo.setSql(ser_activo.getConsultaCustodiosYBienesUnicoRegitro(str_seleccionado));
		tab_consulta_activo.ejecutarSql();
		sel_fil_acta.cerrar();
	}

	/**
	 * Prepara la pantalla de selecci&oacute;n de tipos de actas
 	 */
	public void preparaFiltraoActa() {
		sel_fil_acta.setId("sel_fil_acta");
		sel_fil_acta.setSeleccionTabla(ser_activo.getTipoActas(), "ide_aftidoc");
		sel_fil_acta.setTitle("Seleccione una o varias Actas");
		sel_fil_acta.getBot_aceptar().setMetodo("aceptarFiltro");
		agregarComponente(sel_fil_acta);
	}

	/**
	 * @return the sel_fil_acta
	 */
	public SeleccionTabla getSel_fil_acta() {
		return sel_fil_acta;
	}

	/**
	 * @param sel_fil_acta
	 *            the sel_fil_acta to set
	 */
	public void setSel_fil_acta(SeleccionTabla sel_fil_acta) {
		this.sel_fil_acta = sel_fil_acta;
	}

	/**
	 * @return the ser_activo
	 */
	...
	public pre_activos_consulta_unico() {
		...
		// boton filtrar actas
		Boton bot_filtro_actas = new Boton();
		bot_filtro_actas.setIcon("ui-pencil");
		bot_filtro_actas.setValue("Filtrar Actas");
		bot_filtro_actas.setMetodo("abrirFiltro");
		bar_botones.agregarBoton(bot_filtro_actas);
		preparaFiltraoActa();

		System.out.println("Pantalla pre_activos_consulta_unico ");
		tab_consulta_activo.setId("tab_consulta_activo");
		tab_consulta_activo.setSql(ser_activo.getConsultaCustodiosYBienesUnicoRegitro());
