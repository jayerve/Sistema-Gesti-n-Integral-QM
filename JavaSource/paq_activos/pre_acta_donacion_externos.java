 ...
 * 
 */
public class pre_acta_donacion_externos extends Pantalla {
	...
	private String parametroSecuencial = "p_sec_acta_bajas_externo";
	private String tipoDeActa = "8";
	 ...
	 * Constructor
	 */
	public pre_acta_donacion_externos() {
		System.out.println("pre_acta_donacion_externos");
	...
	public void aceptarReporte() {
		if (rep_reporte.getReporteSelecionado().equals("Acta Donacion")) {
			if (rep_reporte.isVisible()) {
				p_parametros = new HashMap();
				rep_reporte.cerrar();
				p_parametros.put("titulo", "ACTA DE DONACIÓN No. " + tab_cabecera.getValor("nro_secuencial_afdoc"));
	...
	public static void setPar_secuencial_acta(String par_secuencial_acta) {
		pre_acta_donacion_externos.par_secuencial_acta = par_secuencial_acta;
	}
