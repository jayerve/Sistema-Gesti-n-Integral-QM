...
public class pre_activos_consulta_historico_actas_custodio extends Pantalla {
	...
	public pre_activos_consulta_historico_actas_custodio() {
		bar_botones.limpiar();
		...
		System.out.println("Pantalla pre_activos_consulta_historico_actas_custodio ");
		tab_consulta_activo.setId("tab_consulta_activo");
		tab_consulta_activo.setSql(ser_activo.getConsultaHistoricoActasCustodios("0"));
	...
	public void aceptarReporte() {
		if (aut_empleado.getValor() != null) {
			if (rep_reporte.getReporteSelecionado().equals("Consulta Historico Custodio")) {
				if (rep_reporte.isVisible()) {
					p_parametros = new HashMap();
					rep_reporte.cerrar();
					p_parametros.put("titulo", "CONSULTA HISTÓRICO CUSTODIO");
			...
			utilitario.agregarMensajeError("Advertencia", "Debe de realizar la busqueda de un empleado");
			return;
		}
	}
	...
	public void filtrarEmpleado(SelectEvent evt) {
		...
		tab_consulta_activo.setSql(ser_activo.getConsultaHistoricoActasCustodios(aut_empleado.getValor()));
