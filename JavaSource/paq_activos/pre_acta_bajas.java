 ...
 * 
 */
public class pre_acta_bajas extends Pantalla {
	...
	private String parametroSecuencial = "p_sec_acta_bajas";
	private String tipoDeActa = "7";
	 ...
	 * Constructor
	 */
	public pre_acta_bajas() {
		System.out.println("pre_acta_bajas");
	...
	public void aceptarReporte() {
		if (rep_reporte.getReporteSelecionado().equals("Acta Bajas")) {
			if (rep_reporte.isVisible()) {
				p_parametros = new HashMap();
				rep_reporte.cerrar();
				p_parametros.put("titulo", "ACTA DE BAJAS No. " + tab_cabecera.getValor("nro_secuencial_afdoc"));
