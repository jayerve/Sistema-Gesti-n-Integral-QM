...
public class pre_consulta_seguros_activos extends Pantalla {
	...
	public pre_consulta_seguros_activos() {
		...
		aut_vehiculo.setAutoCompletar(ser_activos.getDatosAseguradora()); 
		aut_vehiculo.setMetodoChange("seleccionoAutocompletar"); //ejecuta el metodo seleccionoAutocompletar
		
		Etiqueta eti_colaborador=new Etiqueta("ASEGURADORA:");
		...
		tab_consulta.setSql(ser_activos.getSegurosActivos("0", "","",""));
		tab_consulta.getColumna("numero");
		tab_consulta.getColumna("numero").setNombreVisual("Número Seguro");
		tab_consulta.getColumna("detalle");
		tab_consulta.getColumna("detalle").setNombreVisual("Detalle");
		tab_consulta.getColumna("monto_asegurado_afseg");
		tab_consulta.getColumna("monto_asegurado_afseg").setNombreVisual("Monto");
		tab_consulta.getColumna("porcentaje_asegurable_afseg");
		tab_consulta.getColumna("porcentaje_asegurable_afseg").setNombreVisual("Tasa");
		tab_consulta.getColumna("prima_neta_afseg");
		tab_consulta.getColumna("prima_neta_afseg").setNombreVisual("Prima Neta");
		tab_consulta.getColumna("observacion_afseg");
		tab_consulta.getColumna("observacion_afseg").setNombreVisual("Observaciones");
		tab_consulta.getColumna("fecha_inicio_afseg");
		tab_consulta.getColumna("fecha_inicio_afseg").setNombreVisual("Fecha de Inicio");
		tab_consulta.getColumna("fecha_vigencia_afseg");
		tab_consulta.getColumna("fecha_vigencia_afseg").setNombreVisual("Fecha de Vigencia");
		tab_consulta.getColumna("estado");
		tab_consulta.getColumna("estado").setNombreVisual("Estado");
		tab_consulta.getColumna("estado").setLongitud(30);
		tab_consulta.getColumna("aseguradora");
		tab_consulta.getColumna("aseguradora").setNombreVisual("Aseguradora");
...
//		pintarCampos();
	...
	public void seleccionoAutocompletar(SelectEvent evt){
		...
		tab_consulta.setSql(ser_activos.getSegurosActivos("1",aut_vehiculo.getValor(),"",""));
	...
	public void consultar(){
		if (!sec_rango.isVisible()){
			...
			tab_consulta.setSql(ser_activos.getSegurosActivos("2", "", str_fecha1, str_fecha2));
			tab_consulta.ejecutarSql();
