...
public class pre_consulta_activos_por_custodio extends Pantalla {
	...
	public pre_consulta_activos_por_custodio() {
		...
		aut_vehiculo.setAutoCompletar(ser_contrato.getClientesDatosBasicos()); 
		...
		bot_consultar.setValue("Consultar por fechas de Inicio de Contrato");
		...
		tab_consulta.setSql(ser_contrato.getDatosContratos("0", "","",""));

		tab_consulta.getColumna("ide_prcon");
		tab_consulta.getColumna("ide_prcon").setNombreVisual("Código");
		tab_consulta.getColumna("numero_contrato_prcon");
		tab_consulta.getColumna("numero_contrato_prcon").setNombreVisual("Número Contrato");
		tab_consulta.getColumna("monto_prcon");
		tab_consulta.getColumna("monto_prcon").setNombreVisual("Monto de Contrato");
		tab_consulta.getColumna("fecha_inicio_prcon");
		tab_consulta.getColumna("fecha_inicio_prcon").setNombreVisual("Fecha Inicio");
		tab_consulta.getColumna("fecha_fin_prcon");
		tab_consulta.getColumna("fecha_fin_prcon").setNombreVisual("Fecha Fin");
		tab_consulta.getColumna("observacion_prcon");
		tab_consulta.getColumna("observacion_prcon").setNombreVisual("Objeto de Contrato");
		tab_consulta.getColumna("detalle_coest");
		tab_consulta.getColumna("detalle_coest").setNombreVisual("Estado");
		tab_consulta.getColumna("detalle_prtsc");
		tab_consulta.getColumna("detalle_prtsc").setNombreVisual("Tipo Servicio ");
		tab_consulta.getColumna("detalle_pretc");
		tab_consulta.getColumna("detalle_pretc").setNombreVisual("Etapa Contrato");
		tab_consulta.getColumna("tipo_contrato");
		tab_consulta.getColumna("tipo_contrato").setNombreVisual("Tipo Contrato");
		tab_consulta.getColumna("plazo_prcon");
		tab_consulta.getColumna("plazo_prcon").setNombreVisual("Plazo Contrato");
		tab_consulta.getColumna("detalle_prtip");
		tab_consulta.getColumna("detalle_prtip").setNombreVisual("Tiempo");
		tab_consulta.getColumna("ruc_comercial_recli");
		tab_consulta.getColumna("ruc_comercial_recli").setNombreVisual("Ruc Cliente");
		tab_consulta.getColumna("nombre_comercial_recli");
		tab_consulta.getColumna("nombre_comercial_recli").setNombreVisual("Nombre Cliente");
		tab_consulta.getColumna("ruc_tepro");
		tab_consulta.getColumna("ruc_tepro").setNombreVisual("Ruc Proveedor");
		tab_consulta.getColumna("nombre_tepro");
		tab_consulta.getColumna("nombre_tepro").setNombreVisual("Nombre Proveedor");
	...
	public void seleccionoAutocompletar(SelectEvent evt){
		...
		tab_consulta.setSql(ser_contrato.getDatosContratos("1",aut_vehiculo.getValor(),"",""));
	...
	public void consultar(){
		if (!sec_rango.isVisible()){
			...
			tab_consulta.setSql(ser_contrato.getDatosContratos("2", "", str_fecha1, str_fecha2));
			tab_consulta.ejecutarSql();
