...
public class pre_ficha_medica extends Pantalla {
	...
	public pre_ficha_medica() {
		...
		tab_ficha_medica.getColumna("MES_EDAD_SAFIM").setEtiqueta();
		...
		if (tab_ficha_medica.isFocus()){
			if (aut_empleado.getValor()!=null){
				if (ide_geedp_activo!=null && !ide_geedp_activo.isEmpty()){		
					...
					tab_ficha_medica.setValor("IDE_GEEDP",ide_geedp_activo);
					tab_ficha_medica.setValor("IDE_GTEMP", aut_empleado.getValor());		
