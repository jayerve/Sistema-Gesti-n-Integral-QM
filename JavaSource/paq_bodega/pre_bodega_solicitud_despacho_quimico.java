...
public class pre_bodega_solicitud_despacho_quimico  extends Pantalla{
	...
	public pre_bodega_solicitud_despacho_quimico()  {
		...
		tab_tabla.getColumna("aprobacion_bodega").setNombreVisual("APROBADA BODEGA");
		tab_tabla.getColumna("aprobacion_bodega").setRadioVertical(false);
		
		tab_tabla.getColumna("rechazo_bodega").setVisible(true);
		tab_tabla.getColumna("rechazo_bodega").setNombreVisual("RECHAZADA BODEGA");
...
/*___________________________*/
	...
	public void prepararSelectorSolicitudesProcesadas() {
		...
		set_solicitudes_procesadas.setSeleccionTabla("Select ide_solicitud, ide_solicitud as id, estado_solicitud, fecha_solicitud, observacion from  solicitud_items  where  estado_solicitud="+ "'"+ aprobada + "'" + " and tipo="+ "'"+ tipoSolicitudQuimco + "'", "ide_solicitud");
	...
	public void seleccionaParametros() {
		...
		if (com_anio.getValue() != null) {
			tab_tabla.setCondicion("ide_geani=" + com_anio.getValue() + " AND estado_solicitud="+ "'"+ aprobadaBodega + "'" + " and tipo="+ "'"+ tipoSolicitudQuimco + "'");
	...
	public void aceptarReporte() {
		...
		if (rep_reporte.getReporteSelecionado().equals("Solicitud Despacho Quimico")) {
			if (rep_reporte.isVisible()) {
				p_parametros=new HashMap();	
				rep_reporte.cerrar();
				System.out.println("SOLICITUD QUIMICO No. " + tab_tabla.getValor("ide_solicitud"));
		...
		}if (rep_reporte.getReporteSelecionado().equals("Reporte global solicitudes Quimicos")) {
			if (rep_reporte.isVisible()) {
				p_parametros = new HashMap();
				rep_reporte.cerrar();
				p_parametros.put("titulo", "REPORTE GLOBAL DE SOLICITUDES QUIMICOS");
				self_reporte.setSeleccionFormatoReporte(p_parametros, rep_reporte.getPath());
				self_reporte.dibujar();
			}
		}
		...
		if (verificacionEdita()) {
			...
			boolean rechazo = Boolean.parseBoolean(tab_tabla.getValor("rechazo_bodega"));
				...
				if (aprobacion || rechazo)  {
					...
					System.out.println("APROBACION else "+aprobacion);
					System.out.println("RECHAZO else "+rechazo);
