...
public class pre_bodega_solicitud_aprobacion  extends Pantalla{
	...
	public pre_bodega_solicitud_aprobacion()  {
	...
	public void prepararSelectorSolicitudesProcesadas() {
		...
		set_solicitudes_procesadas.setSeleccionTabla("Select ide_solicitud, ide_solicitud as id, estado_solicitud, fecha_solicitud, observacion from  solicitud_items  where  estado_solicitud="+ "'"+ procesada + "'" + " AND ide_gtemp_aprobador="+ide_gtemp_aprobador + " and tipo="+ "'"+ tipoNormal + "'", "ide_solicitud");
	...
	public void seleccionaParametros() {
		...
		if (com_anio.getValue() != null) {
			tab_tabla.setCondicion("ide_geani=" + com_anio.getValue() + " AND estado_solicitud="+ "'"+ aprobada + "'" + " AND ide_gtemp_aprobador="+ide_gtemp_aprobador);
	...
	public void confirmacionGuardarSolicitud(){	
		...
		if (verificacionEdita()) {
			...
			boolean aprobacion = Boolean.parseBoolean(tab_tabla.getValor("rechazo_aprobador"));
			boolean rechazo = Boolean.parseBoolean(tab_tabla.getValor("aprobacion_aprobador"));
