...
public class pre_consulta_comprobantes_asiento_detallado extends Pantalla{
	...
	public pre_consulta_comprobantes_asiento_detallado(){
		...
		tab_factura_consulta.setSql(ser_facturacion.getComprobantesContabilizados_detallado("0","","0","1900-01-01","1900-01-01",com_comprobante.getValue().toString(),"false"));
		...
		tab_factura_consulta.getColumna("detalle_conac").setFiltroContenido();
	...
	public void seleccionaOpcion (){
		...
		tab_factura_consulta.setSql(ser_facturacion.getComprobantesContabilizados_detallado("1",aut_factura.getValor(),"0",fecha_inicial,fecha_final,com_comprobante.getValue().toString(),che_aplica_fecha.getValue().toString()));
