...
public class pre_consulta_control_previo extends Pantalla {
	...
	public pre_consulta_control_previo() {
		...
		aut_vehiculo.setAutoCompletar(ser_contrato.getContratosControlPrevio()); 
		aut_vehiculo.setMetodoChange("seleccionoAutocompletar"); //ejecuta el metodo seleccionoAutocompletar
		
		Etiqueta eti_colaborador=new Etiqueta("CONTRATO:");
		...
		bot_consultar.setValue("Consultar por fechas de Control");
		...
		tab_consulta.setSql(ser_contrato.getDatosControlPrevio("0", "","",""));

		tab_consulta.getColumna("ide_precp");
		tab_consulta.getColumna("ide_precp").setNombreVisual("Código");
		tab_consulta.getColumna("tipo_control");
		tab_consulta.getColumna("tipo_control").setNombreVisual("Tipo Control");
		tab_consulta.getColumna("detalle_precp");
		tab_consulta.getColumna("detalle_precp").setNombreVisual("Detalle de Control");
		tab_consulta.getColumna("fecha_registro_precp");
		tab_consulta.getColumna("fecha_registro_precp").setNombreVisual("Fecha de Control");
		tab_consulta.getColumna("ide_prcon");
		tab_consulta.getColumna("ide_prcon").setNombreVisual("Código Contrato");
		tab_consulta.getColumna("numero_contrato_prcon");
		tab_consulta.getColumna("numero_contrato_prcon").setNombreVisual("Num. de Contrato");
		tab_consulta.getColumna("observacion_prcon");
		tab_consulta.getColumna("observacion_prcon").setNombreVisual("Objeto de Contrato");
		tab_consulta.getColumna("detalle_predo");
		tab_consulta.getColumna("detalle_predo").setNombreVisual("Documento Control ");
		tab_consulta.getColumna("detalle_prtcd");
		tab_consulta.getColumna("detalle_prtcd").setNombreVisual("SI/NO");
		tab_consulta.getColumna("detalle_prcpd");
		tab_consulta.getColumna("detalle_prcpd").setNombreVisual("Observación");
	...
	public void seleccionoAutocompletar(SelectEvent evt){
		...
		tab_consulta.setSql(ser_contrato.getDatosControlPrevio("1",aut_vehiculo.getValor(),"",""));
	...
	public void consultar(){
		if (!sec_rango.isVisible()){
			...
			tab_consulta.setSql(ser_contrato.getDatosControlPrevio("2", "", str_fecha1, str_fecha2));
			tab_consulta.ejecutarSql();
